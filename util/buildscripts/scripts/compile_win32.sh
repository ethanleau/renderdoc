...
if [ ! -f ./Win32/Release/yeecapture.dll ] || [ ! -f ./Win32/Release/qyeecapture.exe ] || [ ! -f ./Win32/Release/yeecapturecmd.exe ] ; then
...
if [ ! -f ./x64/Release/yeecapture.dll ] || [ ! -f ./x64/Release/qyeecapture.exe ] || [ ! -f ./x64/Release/yeecapturecmd.exe ] ; then
