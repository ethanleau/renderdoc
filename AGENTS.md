...
- In the same change, update `docs/YeeCapture.md` whenever a commit adds, removes, or materially changes fork behavior, compatibility policy, versioned diagnostics, validation requirements, or the local commit ledger. Refresh hashes in the ledger after rebasing `HTCapture`.
